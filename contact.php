...
<html lang="en">
    ...
    ?>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand" href="project.html">Clothing Store</a>
      ...
      <h1 class="se-heading text--">Contact Page</h1>
      ...
      <br>
       ...
       <form action="mailto:huang18g@uwindsor.ca" method="post" enctype="text/plain;">
        <p>&nbsp;</p>
        <p>Your name:<br> <input type="text" size="35" name="Email"</p>
        <br/>
        <p>Your Comments:</p>
        <p><textarea name="comments" rows="10" cols="80"></textarea></p>
        <p>Click the <i>Send</i> button to E-mail your feedback. Thank you! </p>
