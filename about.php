      	...
      	<div class="row justify-content-center">
            <div class="col-lg-6">
                 <h2>The Clothing Store You Need</h2>
                     <p class="lead">The Clothing Store has a long history and deep-rooted connection with sport. It’s broad and diverse portfolio in both the Sport Performance and Sport Inspired categories ranges from major global sports to regional grassroot events  and local sneaker culture. This has enabled The Clothing Store to transcend cultures and become one of the most recognized, credible, and iconic brands both on and off the field of play</p>
              <br>       
              <center><img class="img-fluid rounded-circle mb-4" src="logo.jpg" width="150" height="150" alt="..."></center>
                </div>
          </div>
      </div>
